...
sub Marpa::R3::Scanless::R::new {
    ...
    my $g1_recce_args =
        Marpa::R3::Internal::Scanless::R::set( $self, "new", @args );
    my $too_many_earley_items = $g1_recce_args->{too_many_earley_items};

    my $slg = $self->[Marpa::R3::Internal::Scanless::R::GRAMMAR];

    my $thick_g1_grammar =
        $slg->[Marpa::R3::Internal::Scanless::G::THICK_G1_GRAMMAR];
    $g1_recce_args->{grammar} = $thick_g1_grammar;
    my $thick_g1_recce =
        $self->[Marpa::R3::Internal::Scanless::R::THICK_G1_RECCE] =
    ...
    $self->[Marpa::R3::Internal::Scanless::R::C]      = $thin_self;
    $self->[Marpa::R3::Internal::Scanless::R::EVENTS] = [];
    Marpa::R3::Internal::Scanless::convert_libmarpa_events($self);
...
sub Marpa::R3::Internal::Scanless::R::set {
    ...
    if ( $method eq 'new' ) {
        ...
        state $slg_class = 'Marpa::R3::Scanless::G';
        my $slg = $flat_args{$arg_name};
        Marpa::R3::exception(
            qq{Marpa::R3::Scanless::R::new() called without a "$arg_name" argument}
        ) if not defined $slg;
    ...
    state $copy_arg_to_index = {
        trace_file_handle => Marpa::R3::Internal::Scanless::R::TRACE_FILE_HANDLE,
...
sub Marpa::R3::Scanless::R::read {
    ...
    my $thin_slr = $self->[Marpa::R3::Internal::Scanless::R::C];
    my $trace_terminals =
        $self->[Marpa::R3::Internal::Scanless::R::TRACE_TERMINALS] // 0;
    my $trace_lexers =
        $self->[Marpa::R3::Internal::Scanless::R::TRACE_LEXERS] // 0;
...
sub Marpa::R3::Scanless::R::lexer_set {
    my ( $slr, $lexer_name ) = @_;
    my $slg = $slr->[Marpa::R3::Internal::Scanless::R::GRAMMAR];
    my $lexer_id = $slg->[Marpa::R3::Internal::Scanless::G::LEXER_BY_NAME]->{$lexer_name};
    Marpa::R3::exception( "Attempt to switch to unknown lexer: $lexer_name" ) if not defined $lexer_id;
    my $thin_slr = $slr->[Marpa::R3::Internal::Scanless::R::C];
...
my $libmarpa_trace_event_handlers = {
    ...
    'g1 accepted lexeme' => sub {
        ...
        my $slg              = $slr->[Marpa::R3::Internal::Scanless::R::GRAMMAR];
        my $lexer_name =
            $slg->[Marpa::R3::Internal::Scanless::G::LEXER_NAME_BY_ID]
            ->[$lexer_id];
...
sub Marpa::R3::Scanless::R::resume {
    ...
    my $trace_lexers = $slr->[Marpa::R3::Internal::Scanless::R::TRACE_LEXERS] // 0;
...
sub Marpa::R3::Scanless::R::read_problem {
    ...
    my $lexer_id = $thin_slr->current_lexer();
    my $thick_lex_grammar =
        $grammar->[Marpa::R3::Internal::Scanless::G::THICK_LEX_GRAMMARS]->[$lexer_id];
    my $lex_tracer = $thick_lex_grammar->tracer();
...
sub Marpa::R3::Scanless::R::ambiguity_metric {
    ...
    my $ordering = $thick_g1_recce->[Marpa::R3::Internal::Recognizer::O_C];
