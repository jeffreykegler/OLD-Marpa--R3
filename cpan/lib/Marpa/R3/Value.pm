...
sub Marpa::R3::Recognizer::ordering_create {
    my ($recce) = @_;
    ...
    $recce->[Marpa::R3::Internal::Recognizer::O_C] =
    ...
    return 1;
} ## end sub Marpa::R3::Recognizer::ordering_create
...
sub resolve_recce {
    ...
    my $trace_file_handle =
        ...
        FIND_CONSTRUCTOR: {
            ...
            if ($resolution) {
                $recce->[
                    Marpa::R3::Internal::Recognizer::PER_PARSE_CONSTRUCTOR
                ] = $resolution->[1];
        ...
        RULE: for my $rule_id ( $grammar->rule_ids() ) {
            ...
            DETERMINE_BLESSING: {
                ...
                my $blessing =
                    Marpa::R3::Internal::Recognizer::rule_blessing_find(
                    $recce, $rule_id );
        ...
        SYMBOL: for my $lexeme_id ( 0 .. $#{$symbols} ) {
            my $semantics =
                Marpa::R3::Internal::Recognizer::lexeme_semantics_find(
                $recce, $lexeme_id );
            if ( not defined $semantics ) {
                ...
                $message
                    .= q{  }
                    . $recce
                    ->[Marpa::R3::Internal::Recognizer::ERROR_MESSAGE];
                Marpa::R3::exception($message);
...
sub Marpa::R3::Recognizer::value {
    ...
    my $rules     = $grammar->[Marpa::R3::Internal::Grammar::RULES];
    my $symbols   = $grammar->[Marpa::R3::Internal::Grammar::SYMBOLS];
    my $token_values = $recce->[Marpa::R3::Internal::Recognizer::TOKEN_VALUES];
