...
Marpa::R3::BNF - BNF Interface (obsoleted)
...
itself|Marpa::R3::Scanless>.

=head1 The source string

Stuifzand interface  source strings are specified using the 
L<the C<source> named argument of Marpa::R3's grammars|Marpa::R3::NAIF::Grammar/"source">.
BNF source strings perform the functions of
the
L<C<rules>|Marpa::R3::NAIF::Grammar/"rules">
and the
L<C<start>|Marpa::R3::NAIF::Grammar/"start">
...
Events and pauses are the most visible of these features.
