...
The primary purpose of this document is to act as notes
to myself.
Statements made in this document should in no sense be
taken as commitments.
Items mentioned may be removed, changed, re-ranked, etc., etc.
arbitrarily, suddenly and without notice.
